import sys
# Bulletproof path injection for the qed module
sys.path.insert(0, "/global/scratch/users/vaibhavvaiyakarnam/bdp_tddft/qed_tddft")
...
# Create 11 frequency points (in eV) centered at 3.276 eV (+/- 0.5 eV)
ev_conversion = 27.2114
freqs_ev = numpy.linspace(2.776, 3.776, 11)
